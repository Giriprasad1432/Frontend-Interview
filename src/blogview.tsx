...
const Blogview = ({...props}) => {
    ...
    return (
        <div className="flex justify-center  bg-black h-screen relative overflow-hidden">
            ...
            {(post > 0) && <div className="absolute top-1/2 left-1/10 -translate-x-1/10 -translate-y-1/2 border-gray-800 border rounded-2xl w-[20%] h-80">
            ...
            <motion.div className="inset-0 absolute z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-150 border-gray-800 border rounded-2xl w-[30%]"
                key={post}
                custom={direction}
                variants={variants}
                initial="enter"
            ...
            {(post < data.length - 1) && <div className="absolute top-1/2 left-9/10 -translate-x-9/10 -translate-y-1/2 border-gray-800 border rounded-2xl w-[20%] h-80">
                <img className="object-cover w-full h-full" src={data[post + 1].coverImage}></img>
            </div>}
